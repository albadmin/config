...
curl -X POST -H 'Accept: application/json' -H 'project-id: 5c1ad332-d082-46b6-b3d7-94497c7468ad' -H "Authorization: Bearer ${TOKEN}" http://localhost:8080/api/v1/wizzard/dependency/e8f23360-9327-490e-9c4b-b288a3f93009/vnfName/iperf-server/ipAddr/127.0.0.1
